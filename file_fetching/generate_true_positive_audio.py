...
def copy_required_files(code, split, conf, delete_files):
    ...
    array_unique= df_w_differences["# birdnet x datasheet"]
    array_unique= list(set(array_unique))
    array_unique
    array_data= df_w_differences["# birdnet x datasheet"]

    samples_audio_bnfails= code+ "\\audio_files_tp\\"
